...
class VendedorController extends Controller
{
    ...
    {
        return view('vendedor.propiedad.crear');
    }
    ...
    public function guardarPropiedad(Request $request)
    {
        $request->validate([
            ...
            'fotos.*' => 'image|mimes:jpg,png,jpeg,gif,svg|max:2048', // validamos las fotos
        ]);
        ...
        return redirect()->route('vendedor.propiedades')->with('success', 'Propiedad registrada con éxito');
    }
