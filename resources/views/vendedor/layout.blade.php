        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="{{ route('vendedor.dashboard') }}" class="text-xl font-bold text-gray-800">Mi Dashboard</a>
                </div>

                <!-- Menú de navegación -->
                <div class="flex items-center space-x-4">
                    <a href="" class="text-gray-700 hover:text-gray-900">Mis Propiedades</a>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                            <form action="{{ route('vendedor.logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Cerrar Sesión</button>
                            </form>
                        </div>
                    </div>
